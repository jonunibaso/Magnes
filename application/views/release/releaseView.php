    ...
    <div id="pad-wrapper" class="form-page">
            ...
            <div class="span8 column">
                <form itemscope itemtype="http://schema.org/MusicAlbum">
                    ...
                    <div class="field-box">
                        ...
                        ?>
                        <br><a id="saveTrackBtn" class="btn">Save</a>
                        <?
                        }?>
                    </div>
                    <div class="field-box">
        ...
        <div class="span4 column pull-right">
                ...
                <div class="field-box">
                    ...
                    <div style="border: 1px solid #ddd; width: 220px; height: 220px; overflow: hidden;">
                        ...
                        <? if ($release->img_url==""){
                            ...
                            ?>
                            <img itemprop="thumbnailUrl" width="220" class="lazy" src="<? echo $release->img_url; ?>" data-src="<? echo $release->img_url; ?>" alt="<? echo $release->artist_name." - ".$release->title; ?>"/>
                            <noscript>
                                <img itemprop="thumbnailUrl" width="220" src="<? echo $release->img_url; ?>" alt="<? echo $release->artist_name." - ".$release->title; ?>"/>
                            </noscript>
                            <?
                        }
                        ?>
            ...
            <div class="field-box">
                ...
                <textarea class="span8" rows="5" readonly style="cursor: pointer; margin-left: 5px; margin-top: 10px; background: none repeat scroll 0 0 #FFFFFF; color: #333333;"><? echo $release->extra_info; ?></textarea>
            </div>
        </form>
    </div>
</div>
